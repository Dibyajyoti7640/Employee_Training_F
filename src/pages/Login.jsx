...
import { login, setError } from "../Slices/AuthSlice";
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            {error && (
              <div
                ...
                style={{
                  animation:
                    "shake 0.5s cubic-bezier(.36,.07,.19,.97) both, pulseRedFade 3s infinite",
                }}
              >
            ...
            >
              ...
              <div
                className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-gray-400 transition-colors duration-300 group-hover:text-indigo-500"
                style={{ top: "32px" }}
              >
                <Mail size={20} />
              </div>
